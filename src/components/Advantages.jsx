  ...
  return (
    <section id="vorteile" className="bg-[#F8F8F8]">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
        <div className="rounded-[2.5rem] bg-[#12372A] p-8 text-white shadow-[0_30px_90px_rgba(18,55,42,0.20)] lg:p-10">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {advantages.map((item) => (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F7F4EE] font-semibold text-[#12372A]">
                ✓
              </div>
